...
# --- 2. FORCED WHITE THEME & TABLE WRAPPING CSS ---
st.markdown("""
    <style>
    ...
    .wrapped-table th { 
        background-color: #f3f4f6; border: 1px solid #e5e7eb; padding: 8px; text-align: left; color: #1f2937;
    }
    .wrapped-table td { 
        border: 1px solid #e5e7eb; padding: 8px; vertical-align: top; word-wrap: break-word; 
        white-space: normal !important; line-height: 1.4;
    }
    .comment-bubble { 
        background-color: #f0f2f6; border-radius: 10px; padding: 12px; margin: 2px 0; 
        color: #1f2937; font-size: 13px; display: inline-block; width: 100%;
    }
...
def generate_pdf(dataframe, criteria_cols):
    ...
    for _, row in dataframe.iterrows():
        ...
        data.append([Paragraph(comment_text, comment_style), "", "", "", "", "", "", "", "", ""])
